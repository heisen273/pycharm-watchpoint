...
# ---------------------------------------------------------------------------
# These exercise the builtin that drives the Variables-panel watch icon across
# the whole call stack. It must report (name, id(frame)) pairs by frame
# identity / object identity – never by bare name – so the icon follows the
# watched object into caller/callee frames without ghost-decorating unrelated
